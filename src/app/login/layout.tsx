    ...
    <>
      ...
      <div className="bg-sky-700 border-t border-sky-600 px-4 py-1.5 flex items-center justify-between" dir="rtl">
        ...
        <div className="flex flex-col gap-1.5 items-center">
          ...
          <a href="https://www.instagram.com/remember_ronel?igsh=ZW80bjE3bnpvaXJ1" target="_blank" rel="noopener noreferrer" title="אינסטגרם" className="text-white/80 hover:text-white transition-colors">
          ...
          <a href="https://www.tiktok.com/@remember_ronel?_r=1&_t=ZS-95ztIJ4zEzV" target="_blank" rel="noopener noreferrer" title="טיקטוק" className="text-white/80 hover:text-white transition-colors">
            <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor">
