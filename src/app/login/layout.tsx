...
export default function LoginLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
      ...
      <div className="bg-sky-700 border-t border-sky-600 px-4 py-2 flex flex-col gap-1.5" dir="rtl">
        <a
        ...
        <a href="https://chaim-beronel.org/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-white/80 hover:text-white text-xs transition-colors">
        ...
        <a href="https://www.instagram.com/remember_ronel?igsh=ZW80bjE3bnpvaXJ1" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-white/80 hover:text-white text-xs transition-colors">
        ...
        <a href="https://www.tiktok.com/@remember_ronel?_r=1&_t=ZS-95ztIJ4zEzV" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-white/80 hover:text-white text-xs transition-colors">
          <svg viewBox="0 0 24 24" className="w-4 h-4 flex-shrink-0" fill="currentColor">
