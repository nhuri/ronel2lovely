    ...
    <div className="space-y-4" dir="rtl">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-5 sm:p-6">
        ...
        <p className="text-xs text-gray-400 mt-1.5">
          {gender === "נקבה"
            ? "בואי להיות השדכנית של עצמך - סימון הצעה כלא מתאימה ירענן את ההצעות המומלצות עבורך"
            : "בוא להיות השדכן של עצמך - סימון הצעה כלא מתאימה ירענן את ההצעות המומלצות עבורך"}
        </p>
      </div>
