  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4" dir="rtl">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 max-w-md w-full">
        ...
        <a
          href="mailto:ronel2lovely@gmail.com"
          className="flex items-center gap-3 p-4 bg-sky-50 rounded-xl border border-sky-100 hover:border-sky-300 transition-colors group"
        >
          ...
          <div>
            ...
            <p className="text-sm font-medium text-sky-600 group-hover:text-sky-700 transition-colors" dir="ltr">
